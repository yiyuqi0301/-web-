...
function drewImportanceEcharts(){
	...
	//alert(y+","+m);
     $.ajax({
        type : "post",
        async : false,
        url : "Evaluate_ImportanceServlet?method=getImportance",
        data : {year:y,month:m},
        dataType : "json", 
        success : function(result) {
                   if (result) {
                 	  ...
                 	  var index=0;
                 	  if(score1[0]>score2[0]&&score1[0]>score3[0]&&score1[0]>score4[0])
                 		  index=1;
                 	  else if(score2[0]>score1[0]&&score2[0]>score3[0]&&score2[0]>score4[0])
                 		  index=2;
                 	  else if(score3[0]>score1[0]&&score3[0]>score2[0]&&score3[0]>score4[0])
                 		  index=3;
                 	  else
                 		  index=4;
...
function drewAllImportanceEcharts(){
	id = [];
	 time_s = [];
	 score1 = [];
	 score2 = [];
	...
	//alert(y+","+m);
     $.ajax({
        type : "post",
        async : false,
        url : "Evaluate_ImportanceServlet?method=getAllImportance",
        data : {year:y},
        dataType : "json", 
        success : function(result) {
                   if (result) {
